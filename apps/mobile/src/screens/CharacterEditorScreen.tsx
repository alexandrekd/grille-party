...
export function CharacterEditorScreen({
  ...
  return (
    <PhoneFrame bg="linear-gradient(to bottom,#241A2E 0%,#1A1322 42%,#120E18 100%)">
      {/* A flowing, scrollable column instead of independently top/bottom-anchored
       * blocks — with a fixed number of trait rows plus a name field, nothing here
       * guarantees enough vertical room on every real phone; scrolling makes that
       * a non-issue instead of an overlap. */}
      <div style={{ position: "absolute", inset: 0, overflowY: "auto" }}>
        ...
        <div style={{ padding: "0 22px", display: "flex", flexDirection: "column", gap: 15 }}>
        <div>
